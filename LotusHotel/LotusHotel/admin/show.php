...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>LOTUS HOTEL,</p>
				<p>736 Nguyễn Trãi, Phường 5, Quận 6, TP.HCM </p>
				<p>0896468675</p>
			</address>
		...
		<article>
			...
			<table >
					<tr> 
						<td>SĐT : <?php echo $phone; ?> </td>
						
						<td>Email : <?php echo $email; ?> </td>
					</tr>
					<tr> 
						<td>Quốc gia : <?php echo $country; ?> </td>
						<td>Quốc tịch : <?php echo $National; ?> </td>
					</tr>
				</table>
				<br>
				<br>
		...
		<aside>
			...
			<div >
				<p style="text-align:center">Email : 2205CT0067@dhv.edu.vn | 2205CT0001@dhv.edu.vn </p>
			</div>
		</aside>
	</body>
</html>
